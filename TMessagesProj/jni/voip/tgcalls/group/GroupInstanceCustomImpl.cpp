...
public:
    ...
    _onMutedSpeechActivityDetected(std::move(descriptor.onMutedSpeechActivityDetected)) {
        // MeeroX: custom group-call audio bitrate
    ...
    void start() {
        ...
        // MeeroX: WebRTC-Audio-Allocation is driven by the custom group-call audio
        // bitrate instead of Nagram's hardcoded 32kbps. Nagram 12.10.4's added
        // WebRTC-Video-DiscardPacketsWithUnknownSsrc trial is kept.
