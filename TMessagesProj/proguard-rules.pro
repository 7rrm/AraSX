...
# Nagram 12.10.2+: androidx.annotation.Keep driven keep rules
-keep @interface androidx.annotation.Keep
-keep @androidx.annotation.Keep class * { *; }
-keepclasseswithmembers class * { @androidx.annotation.Keep *; }

# Nagram 12.10.2+: Huawei services + checker/javax annotation silence
...
# ---------------------------------------------------------------------------
# Nagram 12.10.2 dropped the bundled ExoPlayer 2 library (com.google.android.
# exoplayer2) in favour of androidx.media3, whose AARs ship their own consumer
# proguard rules. The old ExoPlayer keep/dontnote rules were removed here as
# well - keeping them would make R8 report ~15 missing classes per release.
# ---------------------------------------------------------------------------
...
-keepnames class !tw.nekomimi.nekogram.Meero**, !tw.nekomimi.nekogram.settings.Meero**, !tw.nekomimi.nekogram.config.cell.**, !org.telegram.ui.**Meero**, !org.telegram.ui.**$Meero**, tw.** { *; }
-keepnames class xyz.** { *; }
