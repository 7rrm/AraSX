...
//    public static int saveToGalleryFlags;
    ...
    public static void setProxyEnable(boolean enable) {
        ...
        Utilities.globalQueue.postRunnable(() -> {
            // Nagram 12.10.2+ dropped the (address, port, user, pass, secret) overload;
            // ConnectionsManager now takes the ProxySettings object (null = disabled).
            ConnectionsManager.setProxySettings(finalEnable, finalEnable ? finalInfo.settings : null);
